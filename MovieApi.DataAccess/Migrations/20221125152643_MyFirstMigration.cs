        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlMovie = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    YearOfMovie = table.Column<int>(type: "int", nullable: false),
                    MinimalAge = table.Column<int>(type: "int", nullable: false),
                    Quality = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalHourDuration = table.Column<int>(type: "int", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalMinuteDuration = table.Column<int>(type: "int", nullable: false),
